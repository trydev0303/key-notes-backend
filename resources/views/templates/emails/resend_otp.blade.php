                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"
                                            ...
                                            <p style="font-family: 'Raleway', sans-serif; font-size:17px; color:#171717; font-weight: 700; ">
                                                Your Account Verify Resend OTP!</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center"
                                            ...
                                            <p
                                                style="font-family: 'Raleway', sans-serif; font-size:17px; color:#171717; font-weight: 700;">
                                                We recieved a request to verify your account. Please use the following one-time password to verify yourself</p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="left"
                                            ...
                                            <p
                                                style="font-family: 'Raleway', sans-serif; font-size:17px; color:#171717; font-weight: 700; ">
                                                Your verification OTP <span style="font-weight: 800; font-family: poppins;">{{ $otp }}</span>
                                            </p>
                                        </td>
